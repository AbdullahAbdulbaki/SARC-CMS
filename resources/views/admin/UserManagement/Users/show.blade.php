                        ...
                        <div class="card-body">
                            <table id="example2" class="table table-bordered table-hover ">
                                ...
                                <tr>
                                    ...
                                    <td>{{ $users->name }}</td></tr>
                                <tr><td style="background-color:#808080;font-weight:bold">Email</td><td>{{ $users->email}}</td></tr>
                                <tr>
                                    <td style="background-color:#808080;font-weight:bold;width:200px">Role</td><td>{{ $users->role->name }}</td></tr>
                            </table>
                        </div>
                        <!-- /.card-body -->
