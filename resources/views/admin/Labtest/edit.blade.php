...
<head>
    ...
    <title>SARC CMS | Edit Labtest Info</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card card-info">
                        <div class="card-header">
                            <h3 class="card-title">Edit Labtest Information</h3>
                            <a href="{{ url('/labtest/all') }}" class="btn btn-danger"
                                style="float: right;">back</a>
                        </div>
                        <div class="card-body">
                            <form method="POST" action="{{ route('admin.labtest.update') }}">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="submit" value="Update Labtest Info"
