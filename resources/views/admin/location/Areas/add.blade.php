...
<head>
  ...
  <title>SARC CMS | Add Areas</title>
      ...
      <section class="content-header">
        <div class="container-fluid">
          ...
          <div class="card card-info">
            ...
            <div class="card-body">
              <form method="POST" action="{{ route('admin.lcations.areas.store') }}">
                @csrf
                <!-- Color Picker -->
                ...
                <!-- /.form group -->
                 <!-- Color Picker -->
                      ...
                      <div class="form-group">
                        <label>City</label>
                        <select name="city_id" id="select_city" class="form-select my-colorpicker1"
                            required foccus>
                  ...
                  <div class="form-group">
                    ...
                    <select name="district_id" id="select_district" class="form-select my-colorpicker1"
                        required foccus>
