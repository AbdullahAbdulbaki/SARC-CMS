...
<head>
  ...
  <title>SARC CMS | Add Regions</title>
      ...
      <section class="content-header">
        <div class="container-fluid">
          ...
          <div class="card card-info">
            ...
            <div class="card-body">
              <form method="POST" action="{{ route('admin.lcations.regions.store') }}">
                @csrf
                <!-- Color Picker -->
                ...
                <!-- /.form group -->
                 <!-- Color Picker -->
                  ...
                  <div class="form-group">
                    <label>City</label>
                    <select name="city_id" id="select_city" class="form-control my-colorpicker1 select2"
                        required foccus>
