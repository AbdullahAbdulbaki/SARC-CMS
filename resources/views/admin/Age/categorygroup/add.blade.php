...
<head>
  ...
  <title>SARC CMS | Add Category Group</title>
        ...
        <div class="container-fluid">
          ...
          <div class="card card-info">
            <div class="card-header">
              <h3 class="card-title">Add Category Group Information</h3>
              <a href="{{ url('/Agecategorygroup/all')}}" class="btn btn-danger"  style="float: right;">back</a>
            </div>
            <div class="card-body">
              <form method="POST" action="{{ route('admin.Agecategorygroup.store') }}">
                @csrf
                <!-- Color Picker -->
