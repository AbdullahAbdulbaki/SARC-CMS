...
<head>
  ...
  <title>SARC CMS | Add Diseases Category</title>
        ...
        <div class="container-fluid">
          ...
          <div class="card card-info">
            <div class="card-header">
              <h3 class="card-title">Add Diseases Category Information</h3>
              <a href="{{ url('/diseasescat/all')}}" class="btn btn-danger"  style="float: right;">back</a>
            </div>
            <div class="card-body">
              <form method="POST" action="{{ route('admin.diseasescat.store') }}">
                @csrf
                <!-- Color Picker -->
