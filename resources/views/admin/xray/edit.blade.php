...
<head>
    ...
    <title>SARC CMS | Edit Xray Info</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card card-info">
                        <div class="card-header">
                            <h3 class="card-title">Edit Xray Information</h3>
                            <a href="{{ url('/xray/all') }}" class="btn btn-danger"
                                style="float: right;">back</a>
                        </div>
                        <div class="card-body">
                            <form method="POST" action="{{ route('admin.xray.update') }}">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="submit" value="Update Xray Info"
